...
المحك الحاسم: حالة الـ posterior المرجعي **لحظة التوقف**.

تحديث لاحق مهم (لا تُقرأ مخرجات هذا الملف بمعزل عنه): تبيّن أن 4015/4018 لم تعلنا اكتفاءً
بل **INCOMPLETE**، وأن posterior كل منهما كان **مطابقًا للأوراكل تمامًا**. فالفشل لم يكن
under-sampling ولا سوء اعتقاد، بل **اعتقاد خاطئ عن فضاء الأفعال المتبقي** — انظر
relabel_b1_incompleteness.py و A-007. هذا الملف يبقى صالحًا لبنية التكلفة، أما تفسير
الفشل فمصدره ذاك.
